                ...
                <div className="w-[500px] min-w-[450px] overflow-y-auto bg-white border-r border-slate-200 p-6 flex flex-col gap-6 shadow-sm">
                    ...
                    <div className="border border-slate-200 rounded-2xl p-4">
                        ...
                        <div className="space-y-4">
                            {equipos.map((eq, idx) => (
                                <div key={eq.id} className="rounded-xl border border-slate-200 bg-slate-50 p-4 space-y-3">
                                    ...
                                    <div className="grid grid-cols-2 gap-3">
                                        <div>
                                            <label className="text-[10px] text-slate-500 font-semibold block mb-1">Marca</label>
                                            <input value={eq.marca} onChange={e => actualizarEquipo(eq.id, 'marca', e.target.value)} placeholder="Ej: Samsung" className={inputBase} />
                                        </div>
                                        <div>
                                            <label className="text-[10px] text-slate-500 font-semibold block mb-1">Modelo</label>
                                            <input value={eq.modelo} onChange={e => actualizarEquipo(eq.id, 'modelo', e.target.value)} placeholder="Ej: XYZ-123" className={inputBase} />
                                        </div>
                                    </div>
                                    <div>
                                        <label className="text-[10px] text-slate-500 font-semibold block mb-1">Código QR / Serie</label>
                                    ...
                                    <div>
                                        <label className="text-[10px] text-slate-500 font-semibold block mb-1">Descripción del Trabajo *</label>
                                        <input value={eq.descripcion} onChange={e => actualizarEquipo(eq.id, 'descripcion', e.target.value)} placeholder="Ej: Mantenimiento, Reparación..." className={inputBase} />
                                    </div>
                                </div>
                            ))}
                        </div>
                    ...
                    <div className="border border-slate-200 rounded-2xl p-4">
                        ...
                        <textarea name="notas" value={formData.notas} onChange={handleInput} rows={3} placeholder="Observaciones adicionales..." className={`${inputBase} resize-none`} />
                    </div>
                </div>
